...
In the **PREPARE** column of the [course schedule](https://sta240-f26.github.io/), I will indicate which parts of a book correspond to the lectures.
...
-   [This course page](https://sta240-f26.github.io/) that you are on right now;
-   `R`/`RStudio` via the [Duke Container Manager](https://cmgr.oit.duke.edu/containers);
-   [Canvas](https://canvas.duke.edu/courses/84105), through which you can access...
    -   [Gradescope](https://www.gradescope.com/courses/1351871);
    -   [Ed Discussion](https://edstem.org/us/courses/96707/discussion);
