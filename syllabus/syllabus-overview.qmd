...
This is a course on the mathematics of probability and statistics. In **probability**, we describe the distribution of a random phenomenon and then study how the realizations of that phenomenon typically behave. In **statistics**, we do the reverse; we observe realizations of a random phenomenon with *unknown* distribution, and then use the data to figure out what the distribution is. We will spend twelve weeks on the first, and then three weeks on the second. Topics include set theory, probability spaces, counting methods, conditional probability, discrete and (absolutely) continuous random variables, transformations of random variables, (pseudo)random number generation, bivariate distributions, concentration inequalities, limit theorems, the fundamentals of classical statistics, and maximum likelihood estimation.

Aside from the concrete topics, the course emphasizes four generic intellectual themes:

- Students in this class will deepen their mathematical maturity. They will get a workout with all of the main ideas and techniques of univariate calculus, they will encounter topics like set theory and combinatorics which may be new to them, and they will get a taste of rigorous mathematical proof;
...
- Probability and statistics are often counterintuitive, and humans frequently make silly and harmful mistakes in reasoning. Students will use their mathematical knowledge to identify and critique these errors...and hopefully avoid making them themselves;
...
|----------|--------------------------------|------------------------|--------|
| Lectures | Old Chem 201                   | MoWe 3:05 PM - 4:20 PM | JZ   |
| Lab 01   | Perkins LINK 060 (Classroom 1) | Th 1:25 PM - 2:40 PM   | Dwija |
| Lab 02   | Perkins LINK 060 (Classroom 1) | Th 3:05 PM - 4:20 PM   | Dwija |
