...
Attendance in lecture is not required. It counts for nothing, and I am not recording it in any way. In fact, lecture attendance is actively *discouraged* if all you will do is putz around on your laptop. Show up and lock in, or go do something more enjoyable with your time. There are many such things. Lab attendance is not required either, but each lab has a graded assignment that is due at midnight the same day. These assignments are designed to be completable by the end of the lab meeting, so showing up and banging it out is probably the easiest way to earn full credit for the lab component of your grade.
