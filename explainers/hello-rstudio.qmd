...
-   (bottom left) this is **the console**. It's a command line where you can type input and get output. At the very least, you can use `R` as an [overgrown calculator](/explainers/math.html);
