...
a.  Which outcome(s) in the sample space are most likely (ie have the largest individual probability of occurring)? Furthermore, how do you know for a fact that you've identified all of them? The sample space is infinite, so presumably you cannot literally check every outcome.
a.  What is the probability of the even numbers?
