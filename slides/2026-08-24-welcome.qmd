...
explain why we need all that math

stats is a mathematical discipline, as mathematical as physics. this is the first in a three-course theory sequence required for stats majors. we have all these methods: linear regression. Do they actually work? What does that even mean? These are mathematical questions, and you need some serious tools to answer them.
