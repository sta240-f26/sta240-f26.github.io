...
When $k=1$, then $P(A)=0$ because that one person has no one they could match with. By the time $k=366$ attend, at least one match is guaranteed as a consequence of the *pigeonhole principle*. Imagine 365 people are in attendance, and by some miracle there are no birthday matches already; every person has a unique birthday. As soon as a 366th person arrives at the party, their birthday *must* match with someone. Every day of the year is already represented in the room.
