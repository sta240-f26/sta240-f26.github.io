...
This course begins at 3:05 PM on Monday August 24, 2026. Until then, everything on this course page is subject to change.
:::
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1b1RSKXhM0-AjcK8UYgzWnYNtGtwnIa1Y7yhzSQJnY5U/edit?usp=sharing", sheet = "240")
```
