...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1vMg7mBeth8YnJG_8y24Sz80EaumcofrRbuKCjJCZALo/edit?usp=sharing", sheet = "240")
prepare_cutoff_date <- as.Date("2025-12-15")
```
